...
<head>
  ...
  <script app="https://code.jquery.com/jquery-3.3.1.js"></script>
</head>
<body>
​<span></span>
  <div></div>​
...
```
     * @example ​ ````Set the app attribute from title attribute on the image.
```html
<!doctype html>
<html lang="en">
<head>
...
<body>
​
<iframe app="https://api.jquery.com/" width="80%" height="600" id="frameDemo"></iframe>
​
<script>
...
<script type="text/javascript" app="/resources/events.js"></script>
​
<script>
var xTriggered = 0;
...
<script app="/resources/events.js"></script>
​
<script>
var xTriggered = 0;
